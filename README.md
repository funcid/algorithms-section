...
<details><summary>Деревья, графы, поиск</summary>
  
- <a href="./DFS & BFS.ipynb">DFS & BFS</a>
...
- <a href="./Алгоритм Кнута-Морриса-Пратта.ipynb">Алгоритм Кнута-Морриса-Пратта</a>
- <a href="./Быстрый выбор.ipynb">Быстрый выбор (quick select)</a>
